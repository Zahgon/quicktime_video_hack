...
func newRiffHeader(size int) riffHeader { _ = "STUB: not implemented"; return *new(riffHeader) }

// serialize this RiffHeader into the given target bytes.Buffer
func (rh riffHeader) serialize(target *bytes.Buffer) error { _ = "STUB: not implemented"; return nil }
...
func newFmtSubChunk() fmtSubChunk { _ = "STUB: not implemented"; return *new(fmtSubChunk) }
...
func WriteWavHeader(length int, wavFile *os.File) error { _ = "STUB: not implemented"; return nil }

// GetWavHeaderBytes creates a byte slice containing a valid wav header using the supplied length.
func GetWavHeaderBytes(length int) ([]byte, error) { _ = "STUB: not implemented"; return nil, nil }
